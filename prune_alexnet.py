...
parser.add_argument("--train_2202", dest="train_2202", action="store_true")
...
parser.add_argument('--num_epochs', default=25, type=int,
                    help='number of batches to train_2202')
parser.add_argument('--num_recovery_batches', default=2, type=int,
                    help='number of batches to train_2202 to recover the network')
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        logging.fatal("You should specify --prune_conv, --prune_linear or --train_2202.")
